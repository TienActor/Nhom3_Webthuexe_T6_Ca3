...
namespace WebThueXe.Areas.Admin.Controllers
{
    public class typesController : BaseController
    {
        ...
        public ActionResult Create([Bind(Include = "id_type,type1,price_day,price_month")] type type, HttpPostedFileBase image)
        {
            if (image != null && image.ContentLength > 0)
            {
                ...
                type.image = "/Content/images/xe" + _fn;
            }
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public ActionResult Edit([Bind(Include = "id_type,type1,price_day,price_month")] type type, HttpPostedFileBase image)
        {
            if (image != null && image.ContentLength > 0)
            {
                string _fn = Path.GetFileName(image.FileName);
